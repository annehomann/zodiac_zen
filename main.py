...
def readings():
    ...
    if user_sign == 'capricorn':
        ...
        answer = input('\t').upper()
        if answer == 'Y':
            with open('taurus' + '.txt', 'w') as file:
        ...
        answer = input('\t').upper()
        if answer == 'Y':
            with open('cancer' + '.txt', 'w') as file:
        ...
        answer = input('\t').upper()
        if answer == 'Y':
            with open('scorpio' + '.txt', 'w') as file:
        ...
        answer = input('\t').upper()
        if answer == 'Y':
            with open('saggitarius' + '.txt', 'w') as file:
